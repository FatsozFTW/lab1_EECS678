...
int main(int argc, char** argv) {
  ...
  bug_info.sentence[6] = NULL; //added this according to slide
...
//Moved the bugs on mars to initialize structure.
  ...
  free(bug_info.sentence[2]); //added this here bc of leak
  ...
  //free(bug_info.useless_bug); // Remove this line if it is problematic (I removed it)
